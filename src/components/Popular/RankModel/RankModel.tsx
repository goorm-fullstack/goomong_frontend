  ...
  return (
    <S.RankModelStyle>
      <div className="rank-model-container">
        <div className="rank-model-title">{category ? category : '데이터 없음'} 1위</div>
        <Link to="#null">
          <div className="top1">
            <img src={GoldMedal} alt="GoldMedal" className="medal-img" />
            <div className="money-seller-name">
              <div className="money">{sellers && sellers.length > 0 ? sellers[0].money : '데이터 없음'}</div>
              <div className="seller-name">{sellers && sellers.length > 0 ? sellers[0].sellerName : '데이터 없음'}</div>
            </div>
        ...
        <Link to="#null">
          <div className="top2">
            ...
            <div className="money-seller-name">
              <div className="money">{sellers && sellers.length > 1 ? sellers[1].money : '데이터 없음'}</div>
              <div className="seller-name">{sellers && sellers.length > 1 ? sellers[1].sellerName : '데이터 없음'}</div>
            </div>
            <div className="image-container">
        ...
        <Link to="#null">
          <div className="top3">
            ...
            <div className="money-seller-name">
              <div className="money"> {sellers && sellers.length > 2 ? sellers[2].money : '데이터 없음'}</div>
              <div className="seller-name">{sellers && sellers.length > 2 ? sellers[2].sellerName : '데이터 없음'}</div>
            </div>
            <div className="image-container">
        ...
        <Link to="#null">
          <div className="top4">
            ...
            <div className="money-seller-name">
              <div className="money">{sellers && sellers.length > 3 ? sellers[3].money : '데이터 없음'}</div>
              <div className="seller-name">{sellers && sellers.length > 3 ? sellers[3].sellerName : '데이터 없음'}</div>
            </div>
            <div className="image-container">
        ...
        <Link to="#null">
          <div className="top5">
            ...
            <div className="money-seller-name">
              <div className="money">{sellers && sellers.length > 4 ? sellers[4].money : '데이터 없음'}</div>
              <div className="seller-name">{sellers && sellers.length > 4 ? sellers[4].sellerName : '데이터 없음'}</div>
            </div>
            <div className="image-container">
