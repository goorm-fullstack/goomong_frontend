...
import * as S from './AgreementStyles';
  ...
  return (
    <S.AgreementStyle>
      <div className="agreement-container">
        <div className="ecep-footer">
          <div className="top">
            <div className="right">
              <Link to="/">
                <img src={Logo} alt="logo" className="logo" />
              </Link>
              <span className="top-title">고객센터</span>
            </div>
          ...
          <div className="history">
            ...
            <svg
              ...
              <g transform="translate(0.000000,48.000000) scale(0.100000,-0.100000)" fill="#c8cbd0" stroke="none">
                <path
...
-75 8 -13 25 -1 102 73 l70 68 -75 72 c-80 78 -88 84 -97 70z"
          ...
          <div className="content-title">이용약관</div>
          <div className="agreement-content">
            ...
            <br />
            <p>
              ② “몰”은 이용자가 약관에 동의하기에 앞서 약관에 정하여져 있는 내용 중 청약철회․배송책임․환불조건 등과 같은 중요한 내용을 이용자가 이해할
            ...
            <br />
            <p>
              ② “몰”은 불특정다수 회원에 대한 통지의 경우 1주일 이상 “몰” 게시판에 게시함으로서 개별 통지에 갈음할 수 있습니다. 다만, 회원 본인의
            ...
            <br />
            <p>
              “몰”은 이용자가 구매신청한 재화 등이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는 지체 없이 그 사유를 이용자에게 통지하고 사전에
            ...
            <br />
            <p>
              ① “몰”과 재화 등의 구매에 관한 계약을 체결한 이용자는 「전자상거래 등에서의 소비자보호에 관한 법률」 제13조 제2항에 따른 계약내용에 관한
            ...
            <br />
            <p>
              ③ 제2항 제2호 내지 제4호의 경우에 “몰”이 사전에 청약철회 등이 제한되는 사실을 소비자가 쉽게 알 수 있는 곳에 명기하거나 시용상품을
            ...
            <p>
              ...
              재화등의 환급을 지연한 때에는 그 지연기간에 대하여 「전자상거래 등에서의 소비자보호에 관한 법률 시행령」 제21조의2에서 정하는
            ...
            <p>
              ...
              정보보호 등에 관한 법률」 제22조 제2항이 규정한 사항을 미리 명시하거나 고지해야 하며 이용자는 언제든지 이 동의를 철회할 수 있습니다.
            </p>
            <br />
            <p>
            ...
            <br />
            <p>
              ⑧ “몰” 또는 그로부터 개인정보를 제공받은 제3자는 개인정보의 수집목적 또는 제공받은 목적이 달성한 때에는 당해 개인정보를 지체 없이
              파기합니다.
            </p>
            <br />
            <p>
