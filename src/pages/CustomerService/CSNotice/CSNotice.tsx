...
const CSNotice: React.FC = () => {
  ...
  const pageCount: number = Math.ceil(noticeList.length / itemsPerPage);
    ...
    <S.CSNoticeStyles>
      ...
      <div className="cs-notice-container">
        <div className="notice-location">
          <div className="left">
            <div className="total-location"><Link to='/cs_home'>구몽 고객센터</Link></div>
        ...
        <div className="cs-notice-content">
          ...
          <ul className="notice-list">
            {currentItems.map((notice: noticeProps, index: number) => (
              <li key={index}>
